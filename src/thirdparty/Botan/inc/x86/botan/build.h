...
* 'configure.py --cpu=x86 --enable-shared-library --disable-static-library --distribution-info=vcpkg x86-windows  --with-pkg-config --link-method=copy --with-debug-info --msvc-runtime=MD'
*
* Target
...
#define BOTAN_DISTRIBUTION_INFO "vcpkg x86-windows"
