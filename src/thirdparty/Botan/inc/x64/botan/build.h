...
* 'configure.py --cpu=x86_64 --enable-shared-library --disable-static-library --distribution-info=vcpkg x64-windows  --with-pkg-config --link-method=copy --with-debug-info --msvc-runtime=MD'
*
* Target
*  - Compiler: cl  /EHs /GR /MD /bigobj /Z7 /O2 /Oi
*  - Arch: x86_64
*  - OS: windows
*/
...
#define BOTAN_DISTRIBUTION_INFO "vcpkg x64-windows"
